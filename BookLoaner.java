...
public class BookLoaner {
    ...
    public void showPrompt() {
        ...
        do {
            ...
            if (Integer.parseInt(bi.getBorrowedCopies()) == Integer.parseInt(bi.getCopies())) {
                System.out.println(" No more copies of this book can be borrowed.");
                continue;
            }
            ...
            do {
                System.out.print(" Borrow the following book? [y/N] ");
